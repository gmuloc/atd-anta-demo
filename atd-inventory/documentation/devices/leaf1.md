...
!
daemon TerminAttr
   exec /usr/bin/TerminAttr -cvaddr=10.73.1.238:9910 -cvauth=token,/tmp/token -cvvrf=default -cvsourceip=192.168.0.12 -cvgnmi -smashexcludes=ale,flexCounter,hardware,kni,pulse,strata -ingestexclude=/Sysdb/cell/1/agent,/Sysdb/cell/2/agent -taillogs
   no shutdown
```
...
| Ethernet4 | host1_Eth1 | *trunk | *110 | *- | *- | 4 |
| Ethernet5 | host1_Eth2 | *trunk | *110 | *- | *- | 4 |
...
| Port-Channel4 | host1_PortChanne1 | switched | trunk | 110 | - | - | - | - | 4 | - |
