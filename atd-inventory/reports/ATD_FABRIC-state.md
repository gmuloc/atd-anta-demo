...
| Test ID | Node | Test Category | Test Description | Test | Test Result | Failure Reason |
| ------- | ---- | ------------- | ---------------- | ---- | ----------- | -------------- |
| 1 | leaf1 | Hardware | Verifies if the power supplies status are within the accepted states list. | VerifyEnvironmentPower | NOT RUN | - |
| 2 | leaf1 | Hardware | Verifies if the fans status are within the accepted states list. | VerifyEnvironmentCooling | NOT RUN | - |
| 3 | leaf1 | Hardware | Verifies if the device temperature is within the acceptable range. | VerifyTemperature | NOT RUN | - |
| 4 | leaf1 | Hardware | Verifies the transceiver's manufacturer against a list of approved manufacturers. | VerifyTransceiversManufacturers | NOT RUN | - |
| 5 | leaf1 | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
| 6 | leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet1 - MLAG_PEER_leaf2_Ethernet1 | NOT RUN | - |
| 7 | leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_SPINE1_Ethernet2 | NOT RUN | - |
| 8 | leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet3 - P2P_LINK_TO_SPINE2_Ethernet2 | NOT RUN | - |
| 9 | leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet4 - host1_Eth1 | NOT RUN | - |
| 10 | leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet5 - host1_Eth2 | NOT RUN | - |
| 11 | leaf1 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel1 - MLAG_PEER_leaf2_Po1 | NOT RUN | - |
| 12 | leaf1 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel4 - host1_PortChanne1 | NOT RUN | - |
| 13 | leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | NOT RUN | - |
| 14 | leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4094 - MLAG_PEER | NOT RUN | - |
| 15 | leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan110 - Tenant_A_OP_Zone_1 | NOT RUN | - |
| 16 | leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan3009 - MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | NOT RUN | - |
| 17 | leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - EVPN_Overlay_Peering | NOT RUN | - |
| 18 | leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback1 - VTEP_VXLAN_Tunnel_Source | NOT RUN | - |
| 19 | leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback100 - Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | NOT RUN | - |
| 20 | leaf1 | Interface State | Vxlan Interface Status & Line Protocol == "up" | Vxlan1 | NOT RUN | - |
| 21 | leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: leaf2_Ethernet1 | NOT RUN | - |
| 22 | leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: spine1_Ethernet2 | NOT RUN | - |
| 23 | leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: spine2_Ethernet2 | NOT RUN | - |
| 24 | leaf1 | IP Reachability | ip reachability test p2p links | Source: leaf1_Ethernet2 - Destination: spine1_Ethernet2 | NOT RUN | - |
| 25 | leaf1 | IP Reachability | ip reachability test p2p links | Source: leaf1_Ethernet3 - Destination: spine2_Ethernet2 | NOT RUN | - |
| 26 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.0.255.3/32 Destination: 192.0.255.1 | NOT RUN | - |
| 27 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.0.255.3/32 Destination: 192.0.255.2 | NOT RUN | - |
| 28 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.0.255.3/32 Destination: 192.0.255.3 | NOT RUN | - |
| 29 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.0.255.3/32 Destination: 192.0.255.4 | NOT RUN | - |
| 30 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.0.255.3/32 Destination: 192.0.255.5 | NOT RUN | - |
| 31 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.0.255.3/32 Destination: 192.0.255.6 | NOT RUN | - |
| 32 | leaf1 | MLAG | MLAG State active & Status connected | MLAG | NOT RUN | - |
...
| 69 | leaf2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: spine2_Ethernet3 | NOT RUN | - |
...
| 106 | leaf3 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4094 - MLAG_PEER | NOT RUN | - |
...
| 143 | leaf4 | NTP | Synchronised with NTP server | NTP | NOT RUN | - |
...
| 180 | leaf4 | Routing Table | Remote Lo0 address | 192.0.255.4 | NOT RUN | - |
...
| 217 | spine2 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_LEAF1_Ethernet3 | NOT RUN | - |
